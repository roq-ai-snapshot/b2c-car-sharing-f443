  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience Freedom on Wheels with B2C Car Sharing - Booking Your Next Ride is Just a Click Away, Managed Efficiently from Our Centralized Dashboards"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience Freedom on Wheels with B2C Car Sharing - Booking Your Next Ride is Just a Click Away, Managed Efficiently from Our Centralized Dashboards`}
            </Text>
            <Box
